  ...
  return {
    ...
    execute: function () {
      ...
      _export("bird", bird = (_dec = ccclass("bird"), _dec2 = property({
        ...
        startUp() {
          var tempStartLocation1 = new Vec3(150, 700);
          var tempStartLocation2 = new Vec3(0, 640);
          var tempStartLocation3 = new Vec3(-150, 720);
          var tempStartLocation4 = new Vec3(-20, 600);
          var tempStartLocation5 = new Vec3(100, 570);
        ...
        update(deltaTime) {
          var birdWidth1 = this.bird1.getComponent(UITransform).height;
          var birdWidth2 = this.bird2.getComponent(UITransform).height;
          var birdWidth3 = this.bird3.getComponent(UITransform).height;
          var birdWidth4 = this.bird4.getComponent(UITransform).height;
          var birdWidth5 = this.bird5.getComponent(UITransform).height; // Get speed of birds
